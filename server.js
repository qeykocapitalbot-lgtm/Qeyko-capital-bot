...
const VIP_PLANS = [
  {id: 1, name: "Plan 1", deposit: 5, profit: 0.20},
...
async function processWithdrawals() {
  try {
    ...
    usersSnap.forEach(async (userDoc) => {
      ...
      user.withdrawals.forEach(async (withdrawal, index) => {
...
setInterval(processWithdrawals, 1 * 60 * 1000);
